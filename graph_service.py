...
class GraphService:
    ...
    def __init__(self, graph_path: Path, teams_path: Path):
        ...
        self._id_to_mascot = {str(team['id']): team.get(
            'mascot', '') for team in teams_list}
    ...
    def find_path(self, start_name: str, end_name: str) -> PathResult:
        ...
        try:
            ...
            if success:
                ...
                return PathResult([self._id_to_name[src], self._id_to_name[dst]],
                                  [{
    ...
    def fallback_to_llm(self, victor_id: int, loser_id: int) -> str:
        ...
        try:
            ...
            victor = self._id_to_name[victor_id] + \
                " " + self._id_to_mascot[victor_id]
            loser = self._id_to_name[loser_id] + \
                " " + self._id_to_mascot[loser_id]
